<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-unlock-alt"></i>
                    <small> <?php echo $this->lang->line('role_permission'); ?></small>
                </h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_perimission" role="tab" data-toggle="tab"
                                              aria-expanded="false"><i
                                        class="fa fa-gear"></i> <?php echo $this->lang->line('role_permission'); ?></a>
                        </li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (has_permission(EDIT, 'administrator', 'permission')) { ?>
                                                        <a href="<?php echo site_url('administrator/permission/index/' . $obj->id); ?>"
                                                           class="btn btn-success btn-xs"><i
                                                                    class="fa fa-folder-open-o"></i> <?php echo $this->lang->line('role_permission'); ?> <?php echo $this->lang->line('setting'); ?>
                                                        </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                ...
                                <div class="x_content" style=" overflow-y: auto; overflow-y: hidden;">
                                    ...
                                    <table class="table table-striped table-bordered dt-responsive nowrap"
                                        ...
                                        <tr>
                                            <th><?php echo $this->lang->line('sl_no'); ?></th>
                                            <th class="role-text"
                                                width="10%"><?php echo $this->lang->line('module'); ?><?php echo $this->lang->line('name'); ?></th>
                                            <th class="role-text"><?php echo $this->lang->line('function'); ?><?php echo $this->lang->line('name'); ?></th>
                                            <th><?php echo $this->lang->line('view'); ?> &nbsp; <input type="checkbox"
                                                                                                       id="fn_view"
                                                                                                       class="role-check"
                                                                                                       value="1"/></th>
                                            <th><?php echo $this->lang->line('add'); ?> &nbsp;<input type="checkbox"
                                                                                                     id="fn_add"
                                                                                                     class="role-check"
                                                                                                     value="1"/></th>
                                            <th><?php echo $this->lang->line('edit'); ?> &nbsp;<input type="checkbox"
                                                                                                      id="fn_edit"
                                                                                                      class="role-check"
                                                                                                      value="1"/></th>
                                            <th><?php echo $this->lang->line('delete'); ?> &nbsp; <input type="checkbox"
                                                                                                         id="fn_delete"
                                                                                                         class="role-check"
                                                                                                         value="1"/>
                                            </th>
                                        ...
                                        <?php if (isset($modules) && !empty($modules)) { ?>
                                            ...
                                            foreach ($modules AS $obj) {
                                                ...
                                                <tr>
                                                    <td class="role-text"
                                                        style="background: #ececec; font-weight: bold;"><?php echo $module; ?></td>
                                                    <td colspan="6" class="role-text"
                                                        style="background: #ececec; font-weight: bold;"><?php echo $obj->module_name; ?>
                                                        &raquo;
                                                    </td>
                                                </tr>
                                                ...
                                                <?php if (isset($operations) && !empty($operations)) { ?>
                                                    ...
                                                    foreach ($operations AS $op) {
                                                            ...
                                                            <tr>
                                                                <td class="role-text"><?php echo $module; ?>
                                                                    .<?php echo $operaton++; ?></td>
                                                                <td colspan="2" class="role-text"
                                                                    style="padding-left: 120px;">
                                                                    <?php echo $op->operation_name; ?>
                                                                    <input type="hidden"
                                                                           name="operation[<?php echo $op->id; ?>]"
                                                                           id="operatio[]"
                                                                           value="<?php echo $op->id; ?>"/>
                                                                </td>
                                                                <td>
                                                                    <?php if ($op->is_view_vissible){ ?>
                                                                    <input type="checkbox" class="fn_view"
                                                                           name="is_view[<?php echo $op->id; ?>]"
                                                                           value="1" <?php if (isset($permission->is_view) && $permission->is_view == 1) {
                                                                        echo 'checked="checked"';
                                                                    } ?> /></td>
                                                                <?php } ?>
                                                                <td>
                                                                    <?php if ($op->is_add_vissible){ ?>
                                                                    <input type="checkbox" class="fn_add"
                                                                           name="is_add[<?php echo $op->id; ?>]"
                                                                           value="1" <?php if (isset($permission->is_add) && $permission->is_add == 1) {
                                                                        echo 'checked="checked"';
                                                                    } ?> /></td>
                                                            <?php } ?>
                                                                <td>
                                                                    <?php if ($op->is_edit_vissible){ ?>
                                                                    <input type="checkbox" class="fn_edit"
                                                                           name="is_edit[<?php echo $op->id; ?>]"
                                                                           value="1" <?php if (isset($permission->is_edit) && $permission->is_edit == 1) {
                                                                        echo 'checked="checked"';
                                                                    } ?> /></td>
                                                            <?php } ?>
                                                                <td>
                                                                    <?php if ($op->is_delete_vissible){ ?>
                                                                    <input type="checkbox" class="fn_delete"
                                                                           name="is_delete[<?php echo $op->id; ?>]"
                                                                           value="1" <?php if (isset($permission->is_delete) && $permission->is_delete == 1) {
                                                                        echo 'checked="checked"';
                                                                    } ?> /></td>
                                                            <?php } ?>
                                                            </tr>
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td colspan="7"
                                                    class="not-found"><?php echo $this->lang->line('no_data_found'); ?></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                            ...
                                            <?php if (has_permission(EDIT, 'administrator', 'permission')) { ?>
                                                <?php if ($role_id == 1) { ?>
                                                    <button type="button" disabled="disabled"
                                                            class="btn btn-success"><?php echo $this->lang->line('update'); ?><?php echo $this->lang->line('role_permission'); ?></button>
                                                <?php } else { ?>
                                                    <button type="submit"
                                                            class="btn btn-success"><?php echo $this->lang->line('update'); ?><?php echo $this->lang->line('role_permission'); ?></button>
                                                <?php } ?>
